...
console.log("Çemberin Alanı:", CemberinCevresi(5));
...
console.log("Çemberi Alanı:", CemberinAlani(15, pi));
...
// 3b çözümü:3b. `ucetambolunenler` adında bir dizi tanımlayın ve bu diziye sayilar dizisindeki 3'ün tam katı olan sayıları atayın (.forEach metodunu kullanın)
...
console.log("üçe tam bülünenler", ucetambolunenler);
...
var ucebolunenlerintoplami = ucetambolunenler.reduce(function (acc, curr) {
  return acc + curr;
}, 0);

console.log("Üçe bölünen sayıların toplami:", ucebolunenlerintoplami);
...
for (var sayi in tekrarlar) {
  if (tekrarlar.hasOwnProperty(sayi) && tekrarlar[sayi] > 1) {
    var tekrarSayisi = tekrarlar[sayi];
    var tekrarString =
